...
def receipt():
    ...
    if CostOfDrinks.get() != '' or CostOfDishes.get() != '':
        ...
        textReceipt.insert(END,'***************************************************\n')
        if e_guj.get()!='0':
            textReceipt.insert(END,f'Gujarati Thali:\t\t\t{int(e_guj.get())*80}\n')

        if e_pun.get()!='0':
            textReceipt.insert(END,f'Punjabi Thali:\t\t\t{int(e_pun.get())*120}\n')

        if e_noo.get()!='0':
            textReceipt.insert(END,f'Chinese Noodles:\t\t\t{int(e_noo.get())*110}\n')

        if e_man.get() != '0':
            textReceipt.insert(END, f'Manchurian:\t\t\t{int(e_man.get()) * 90}\n')

        if e_soup.get() != '0':
            textReceipt.insert(END, f'Chinese Soup:\t\t\t{int(e_soup.get()) * 70}\n')

        if e_pav.get() != '0':
            textReceipt.insert(END, f'Pavbhaji:\t\t\t{int(e_pav.get()) * 100}\n\n')

        if e_bb.get() != '0':
            textReceipt.insert(END, f'Butter Bhaji:\t\t\t{int(e_bb.get()) * 130}\n')

        if e_pizza.get() != '0':
            textReceipt.insert(END, f'Pizza:\t\t\t{int(e_pizza.get()) * 210}\n')

        if e_sw.get() != '0':
            textReceipt.insert(END, f'Sandwich:\t\t\t{int(e_sw.get()) * 95}\n')

        if e_burger.get() != '0':
            textReceipt.insert(END, f'Burger:\t\t\t{int(e_burger.get()) * 60}\n')

        if e_gsw.get() != '0':
            textReceipt.insert(END, f'Grill-Sandwich:\t\t\t{int(e_gsw.get()) * 110}\n')

        if e_biryani.get() != '0':
            textReceipt.insert(END, f'Biryani:\t\t\t{int(e_biryani.get()) * 70}\n')

        if e_jira.get() != '0':
            textReceipt.insert(END, f'Jira-rice:\t\t\t{int(e_jira.get()) * 80}\n')

        if e_sada.get() != '0':
            textReceipt.insert(END, f'Sada Dhosa:\t\t\t{int(e_sada.get()) * 110}\n')

        if e_masala.get() != '0':
            textReceipt.insert(END, f'Masala Dhosa:\t\t\t{int(e_masala.get()) * 100}\n')

        if e_mysore.get() != '0':
            textReceipt.insert(END, f'Mysore Dhosa:\t\t\t{int(e_mysore.get()) * 130}\n')

        if e_chaas.get() != '0':
            textReceipt.insert(END, f'Chaas:\t\t\t{int(e_chaas.get()) * 20}\n')

        if e_pepsi.get() != '0':
            textReceipt.insert(END, f'Pepsi:\t\t\t{int(e_pepsi.get()) * 30}\n')

        if e_coke.get() != '0':
            textReceipt.insert(END, f'Coke:\t\t\t{int(e_coke.get()) * 30}\n')

        if e_sprite.get() != '0':
            textReceipt.insert(END, f'Sprite:\t\t\t{int(e_sprite.get()) * 30}\n')

        if e_sosyo.get() != '0':
            textReceipt.insert(END, f'Sosyo:\t\t\t{int(e_sosyo.get()) * 30}\n')

        if e_juice.get() != '0':
            textReceipt.insert(END, f'Juice:\t\t\t{int(e_juice.get()) * 40}\n')

        if e_mazza.get() != '0':
            textReceipt.insert(END, f'Mazza:\t\t\t{int(e_mazza.get()) * 30}\n')

        if e_shake.get() != '0':
            textReceipt.insert(END, f'Shake:\t\t\t{int(e_shake.get()) * 60}\n')
...
def drink_list():
    ...
    e=Label(d1frame,width=10,text='Chaas',borderwidth=2, relief='ridge',
            anchor='w',fg='royalblue2',bg='light grey',font=("arial",10,"bold"))
    ...
    for student in my_conn: 
        for j in range(len(student)):
            e = Entry(d1frame, width=10, fg='royalblue2') 
...
def dishes_list():
    ...
    for student in mycursor2: 
        for q in range(len(student)):
            e = Entry(d2frame, width=10, fg='royalblue2') 
...
Tframe= Frame(top,bg="grey",bd=10,relief=RIDGE)
Tframe.pack( side = TOP)

l12=Label(Tframe,text="luncheonette POS",height=4,
          width=62,font=("arial",25,"bold"),fg="royalblue2",bg="light grey")
l12.grid(row=0,column=0)

#=======================================================================================
MLframe= Frame(top,bg="grey",bd=10,relief=RIDGE)
MLframe.pack(side = LEFT)

L3frame= Frame(MLframe,bg="light grey",bd=10,relief=RIDGE,width=150)
L3frame.pack(side = BOTTOM)

c301=Label(L3frame,text="Cost Of Drink\t",font=("arial",15,"bold"),fg="royalblue2",
           bg="light grey")
...
c302=Label(L3frame,text="Cost Of Dishes\t",font=("arial",15,"bold"),fg="royalblue2",
           bg="light grey")
...
c307=Label(L3frame,text="Bill Number\t",font=("arial",15,"bold"),fg="royalblue2",
           bg="light grey")
...
c303=Label(L3frame,text="\tService Charge\t",font=("arial",15,"bold"),fg="royalblue2",
           bg="light grey")
...
c304=Label(L3frame,text="\tSub Total\t",font=("arial",15,"bold"),fg="royalblue2",
           bg="light grey")
...
c305=Label(L3frame,text="\tTotal\t",font=("arial",15,"bold"),fg="royalblue2",
           bg="light grey")
...
b50=Button(L3frame,text="Dishes",command=dishes_list,font=("arial",15,"bold"),fg="royalblue2",
           bg="light grey",bd="5")
b50.grid(row=3,column=1)

b51=Button(L3frame,text="Delete",command=Delete,font=("arial",15,"bold"),fg="royalblue2",
           bg="light grey",bd="5")
b51.place(x=650,y=90)

b52=Button(L3frame,text="Insert",command=Insert,font=("arial",15,"bold"),fg="royalblue2",
           bg="light grey",bd="5")
b52.grid(row=3,column=3)

b53=Button(L3frame,text="Print Bill",font=("arial",15,"bold"),fg="royalblue2",
           bg="light grey",bd="5",command=bill)
b53.grid(row=3,column=0)

b54=Button(L3frame,text="Drinks",command=drink_list,font=("arial",15,"bold"),fg="royalblue2",
           bg="light grey",bd="5")
...
Lframe= Frame(MLframe,bg="light grey",bd=10,relief=RIDGE)
Lframe.pack(side = LEFT)

c101=Checkbutton(Lframe,text="Gujarati Thali",variable=var1,onvalue=1,offvalue=0,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=guj)
...
c102=Checkbutton(Lframe,text="Punjabi Thali",onvalue=1,offvalue=0,variable=var2,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=pun)
...
c103=Checkbutton(Lframe,text="Chinese Noodles",onvalue=1,offvalue=0,variable=var3,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=noo)
...
c104=Checkbutton(Lframe,text="Manchurian",onvalue=1,offvalue=0,variable=var4,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=man)
...
c105=Checkbutton(Lframe,text="Chinese Soup",onvalue=1,offvalue=0,variable=var5,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=soup)
...
c106=Checkbutton(Lframe,text="Pav-Bhaji",onvalue=1,offvalue=0,variable=var6,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=pav)
...
c107=Checkbutton(Lframe,text="Butter Bhaji",onvalue=1,offvalue=0,variable=var7,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=bb)
...
c108=Checkbutton(Lframe,text="Pizza",onvalue=1,offvalue=0,variable=var8,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=pizza)
...
c109=Checkbutton(Lframe,text="Sand-Wich",onvalue=1,offvalue=0,variable=var9,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=sw)
...
c110=Checkbutton(Lframe,text="Burger",onvalue=1,offvalue=0,variable=var10,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=burger)
...
c112=Checkbutton(Lframe,text="Grill Sand-Wich",onvalue=1,offvalue=0,variable=var12,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=gsw)
...
c113=Checkbutton(Lframe,text="Biryani",onvalue=1,offvalue=0,variable=var13,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=biryani)
...
c114=Checkbutton(Lframe,text="Jira-Rice",onvalue=1,offvalue=0,variable=var14,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=jira)
...
c115=Checkbutton(Lframe,text="Sada Dhosa",onvalue=1,offvalue=0,variable=var15,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=sada)
...
c116=Checkbutton(Lframe,text="Masala Dhosa",onvalue=1,offvalue=0,variable=var16,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=masala)
...
c117=Checkbutton(Lframe,text="Mysore Dhosa",onvalue=1,offvalue=0,variable=var17,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=mysore)
...
L2frame= Frame(MLframe,bg="light grey",bd=10,relief=RIDGE)
L2frame.pack(side = RIGHT)

c201=Checkbutton(L2frame,text="Chaas",onvalue=1,offvalue=0,variable=var18,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=chaas)
...
c202=Checkbutton(L2frame,text="Pepsi",onvalue=1,offvalue=0,variable=var19,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=pepsi)
...
c203=Checkbutton(L2frame,text="Coke",onvalue=1,offvalue=0,variable=var20,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=coke)
...
c204=Checkbutton(L2frame,text="Sprite",onvalue=1,offvalue=0,variable=var21,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=sprite)
...
c205=Checkbutton(L2frame,text="Sosyo",onvalue=1,offvalue=0,variable=var22,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=sosyo)
...
c206=Checkbutton(L2frame,text="Juice",onvalue=1,offvalue=0,variable=var23,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=juice)
...
c207=Checkbutton(L2frame,text="Mazza",onvalue=1,offvalue=0,variable=var24,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=mazza)
...
c208=Checkbutton(L2frame,text="Shake",onvalue=1,offvalue=0,variable=var25,
                 font=("arial",15,"bold"),fg="royalblue2",bg="light grey",command=shake)
...
MRframe= Frame(top,bg="grey",bd=10,relief=RIDGE)
MRframe.pack(side = RIGHT)

Rframe= Frame(MRframe,bg="light grey",bd=10,relief=RIDGE)
...
b11=Button(Rframe,text="1",command=lambda: press(1),
           fg="black",bg="light grey",bd="5", height=1,width=7,font="arial 11 bold")
b11.grid(row=1,column=1)

b12=Button(Rframe,text="2",command=lambda: press(2),
           fg="black",bd="5",bg="light grey", height=1,width=7,font="arial 11 bold")
...
R3frame= Frame(MRframe,bg="light grey",bd=10,relief=RIDGE)
...
R2frame= Frame(MRframe,bg="light grey",bd=10,relief=RIDGE)
R2frame.pack(side = BOTTOM)

b51=Button(R2frame,text="Total",command=totalcost,
           fg="royalblue2",bd="5",bg="light grey", height=1,width=5,font=("arial",15,"bold"))
b51.grid(row=1,column=1)

b52=Button(R2frame,text="Receipt",command=receipt,
           fg="royalblue2",bd="5",bg="light grey",height=1,width=6,font=("arial",15,"bold"))
